...
class AdminTemplates {
    ...
    private fun formatDate(dateTime: Instant): String {
        val formatter = DateTimeFormatter.ofPattern("MMM d, yyyy h:mm a")
        val localDateTime = converter.convertToDatabaseColumn(dateTime)

        return localDateTime?.format(formatter) ?: LocalDateTime.now().format(formatter)
    }
    ...
    private fun buildBlogPostFormContent(blogPostEntity: BlogPostEntity?): String {
        ...
        val formattedPublishDate = formatDateForInput(post.publishDate)
    ...
    private fun formatDateForInput(instant: Instant): String {
        val localDateTime = converter.convertToDatabaseColumn(instant)
