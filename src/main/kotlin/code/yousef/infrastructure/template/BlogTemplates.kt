    ...
    private fun formatDate(dateStr: String): String {
        try {
            ...
            val javaLocalDateTime = java.time.LocalDateTime.of(
                ...
                localDateTime?.month,
                localDateTime?.dayOfMonth ?: LocalDateTime.now().dayOfMonth,
                localDateTime?.hour ?: LocalDateTime.now().hour,
                localDateTime?.minute ?: LocalDateTime.now().minute,
                localDateTime?.second ?: LocalDateTime.now().second,
                localDateTime?.nano ?: LocalDateTime.now().nano
            )
