  ...
  <footer class="bg-gray-900 text-white py-12">
    <div class="container">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 class="text-xl font-bold mb-4">Yousef</h3>
          <p class="text-gray-400 mb-4">Software Developer & Consultant specializing in modern web applications and scalable architectures.</p>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><router-link to="/projects" class="text-gray-400 hover:text-white transition-colors">Projects</router-link></li>
        ...
        <div>
          ...
          <p class="text-gray-400 mb-2">Email: info@yousef.com</p>
          <p class="text-gray-400 mb-4">Location: City, Country</p>
          <router-link to="/contact" class="inline-block px-4 py-2 bg-primary-600 hover:bg-primary-700 rounded-md transition-colors">Get in Touch</router-link>
        </div>
      </div>
